...
def process_aircraft_data(aircraft_data):
    ...
    for ac in recent_aircraft:
        ...
        if icao in flight_memory:
            ...
            enriched['origin_city'] = flight_memory[icao].get('origin_city')
            enriched['destination_city'] = flight_memory[icao].get('destination_city')
            enriched['origin_airport_name'] = flight_memory[icao].get('origin_airport_name')
            enriched['destination_airport_name'] = flight_memory[icao].get('destination_airport_name')
